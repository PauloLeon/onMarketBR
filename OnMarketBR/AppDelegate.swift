...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "OnMarketBR", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.appendingPathComponent("OnMarketBR.sqlite")
    ...
    func guestExists(){
        ...
        if User.isLoggedIn || !Guest.exists ||  exist{
            ...
            Guest.currentGuest = Guest(token: (guestCache.guest?.token)!, order: (guestCache.guest?.currentOrder)! )
        }
    }
